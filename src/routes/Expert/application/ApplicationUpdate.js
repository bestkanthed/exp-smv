        ...
        <div>
            <div>
                <div class='mask row' style={{borderRight:`solid 8px ${borderColor(application.status)}`}}>
                    ...
                    <span class='col-lg-2' style={{borderLeft : 'solid 1px grey'}}>
                        <span>
                            {application.name}
                        </span>
                        <br/>
                    ...
                    </span>
                    {
                        ...
                        null :
                        <span class='col-lg-2' onClick={()=>{updateForm.style.display='block'}} style={{color:`${borderColor(application.status)}`}}>
