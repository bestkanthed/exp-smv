...
import '../../routes/Expert/order/ApplicationSummary.scss';
...
const OrderSummary = ({user, orders, allowUpdate, idCustomer, supportCustomerView}) => (
    <div>
        {
            orders ?
            orders.map(order =>
                <div class='col-sm-12 col-md-12 col-lg-12' key={order._id}>
